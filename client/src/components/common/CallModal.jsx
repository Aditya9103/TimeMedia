...
export default function CallModal({ onClose }) {
    ...
    const displayNumber = "+91 9810 91 0686";
    ...
    const modalContent = (
        ...
        >
            <div
                className="relative bg-gradient-to-br from-[#3a1418] via-[#4a1820] to-[#3a1418] rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto border-2 border-[#34d399]/30 animate-slideUp"
    ...
    // Render modal at the document body level to prevent CSS transform confinement
