    ...
    <section className="w-full">
      <div className="relative w-full aspect-video md:aspect-auto md:h-[90vh] lg:h-[105vh] overflow-hidden bg-black">
        ...
        <iframe
          ...
          src="https://www.youtube.com/embed/xJ05rWqlS8w?autoplay=1&mute=1&loop=1&playlist=xJ05rWqlS8w&start=18&controls=0&showinfo=0&rel=0&modestbranding=1&iv_load_policy=3&disablekb=1&vq=hd2160&hd=1"
